import * as mathModule from './math_module.mjs';
// import { subtract } from "./math_module.mjs";

// ===========================================================
// User of the subtract API
const handleCallback = function(error, result, time) {
    if (error) {
...
console.log("The 'maxtime' variable is not exported: " +  mathModule.maxTime);